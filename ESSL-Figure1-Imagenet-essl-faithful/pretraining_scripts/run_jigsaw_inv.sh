#!/bin/bash
# E-SSL Figure 1: jigsaw / invariance
set -e
...
SAVE_DIR=./checkpoints/jigsaw_invariance
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain jigsaw / invariance (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: jigsaw / invariance"
echo "Finished: $(date)"
echo "=========================================="
