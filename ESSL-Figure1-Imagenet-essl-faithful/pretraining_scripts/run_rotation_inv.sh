#!/bin/bash
# E-SSL Figure 1: rotation / invariance
set -e
...
SAVE_DIR=./checkpoints/rotation_invariance
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain rotation / invariance (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: rotation / invariance"
echo "Finished: $(date)"
echo "=========================================="
