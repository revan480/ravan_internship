...
scripts/extract_results.py and the existing parsers still match.
    ...
    python -m relssl.eval.linear_probe --data ./imagenet100 \
        --pretrained ./relssl/checkpoints/simclr_relpred/checkpoint_0500.pth.tar
    python -m relssl.eval.linear_probe --data ./imagenet100 --pretrained <ckpt> --eval-rotation
    python -m relssl.eval.linear_probe --data ../moco/cub200_prepared --pretrained <ckpt>
"""
