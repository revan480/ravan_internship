...
KNOBS = [
    ...
    Knob("data", "data", "train", "path", "./relssl/datasets/imagenet100", cli_flag="--data",
    ...
    Knob("IN100", "runtime", "paths", "path", "./relssl/datasets/imagenet100",
         doc="ImageNet-100 root (pipeline/pilot)."),
    Knob("CUB", "runtime", "paths", "path", "./relssl/datasets/cub200_prepared",
         doc="CUB-200 root (pipeline STEP 4)."),
    Knob("FLOWERS", "runtime", "paths", "path", "./relssl/datasets/flowers102_prepared",
