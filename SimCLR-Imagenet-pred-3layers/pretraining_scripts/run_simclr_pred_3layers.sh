#!/bin/bash
# SimCLR + 3-layer MLP Prediction Head — Full Pipeline
set -e
...
SAVE_DIR=./checkpoints/simclr_pred_3layers
CKPT=${SAVE_DIR}/checkpoint_0500.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain SimCLR + 3-layer pred head (500 epochs, λ=0.5)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: simclr_pred_3layers"
echo "Finished: $(date)"
echo "=========================================="
