"""
Data loading utilities for SimCLR + Augmentation Prediction.

Provides:
  - SimCLRTransform: applies a base transform twice to produce two views
  - SimCLRPredTransform: applies augmentations with tracking, returns [view1, view2, aug_label]
