...
def parse_args():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="LooC++ mode: concatenate features from all heads (NOT YET IMPLEMENTED)",
    )
...
def main():
    ...
    if args.looc_plus:
        raise NotImplementedError("LooC++ mode not yet implemented")
    ...
    print(f"  Checkpoint type:{'LooC' if args.looc_backbone else 'MoCo'}")
