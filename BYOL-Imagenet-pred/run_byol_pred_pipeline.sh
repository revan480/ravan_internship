#!/bin/bash
# BYOL + Augmentation Prediction — Full Pipeline
# Run on britannia
# Usage: nohup bash run_byol_pred_pipeline.sh > byol_pred_pipeline.log 2>&1 &

export CUDA_VISIBLE_DEVICES=1
cd ~/projects/ravan_internship/BYOL-Imagenet-pred

ln -sf ~/projects/ravan_internship/Moco-Imagenet/imagenet100 ./imagenet100

echo "=========================================="
echo "STEP 1: BYOL+pred Pre-training (500 epochs, λ=0.5)"
echo "Started: $(date)"
echo "=========================================="
python main_byol.py \
    --data ./imagenet100 \
    ...
    --use-color \
    --use-rotation \
    --save-dir ./checkpoints/exp_byol_pred_05 \
    --workers 16
...
python main_lincls.py \
    --data ./imagenet100 \
    --pretrained ./checkpoints/exp_byol_pred_05/checkpoint_0500.pth.tar \
