#!/bin/bash
# E-SSL Figure 1: vflip / sensitivity
set -e
...
SAVE_DIR=./checkpoints/vflip_sensitivity
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain vflip / sensitivity (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: vflip / sensitivity"
echo "Finished: $(date)"
echo "=========================================="
