#!/bin/bash
# E-SSL Figure 1: invert / invariance
set -e
...
SAVE_DIR=./checkpoints/invert_invariance
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain invert / invariance (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: invert / invariance"
echo "Finished: $(date)"
echo "=========================================="
