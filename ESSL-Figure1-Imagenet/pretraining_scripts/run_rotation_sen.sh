#!/bin/bash
# E-SSL Figure 1: rotation / sensitivity
set -e
...
SAVE_DIR=./checkpoints/rotation_sensitivity
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain rotation / sensitivity (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: rotation / sensitivity"
echo "Finished: $(date)"
echo "=========================================="
