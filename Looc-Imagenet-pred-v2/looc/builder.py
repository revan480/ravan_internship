...
class LooC(nn.Module):
    ...
    def __init__(self, base_encoder, dim=128, K=16384, m=0.999, T=0.2, mlp=True, n_aug=2, lambda_pred=0.0, num_pred_classes=3):
        """
        Args:
            ...
            num_pred_classes: number of prediction classes (3 for angle, 4 for combo)
        """
        ...
        # Augmentation prediction classifier
