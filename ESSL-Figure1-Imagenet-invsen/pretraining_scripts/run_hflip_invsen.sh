#!/bin/bash
# E-SSL Figure 1: hflip / invariance_sensitivity
set -e
...
SAVE_DIR=./checkpoints/hflip_invariance_sensitivity
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain hflip / invariance_sensitivity (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: hflip / invariance_sensitivity"
echo "Finished: $(date)"
echo "=========================================="
