#!/bin/bash
# E-SSL Figure 1: invert / invariance_sensitivity
set -e
...
SAVE_DIR=./checkpoints/invert_invariance_sensitivity
CKPT=${SAVE_DIR}/checkpoint_0200.pth.tar

echo "=========================================="
echo "STEP 1: Pretrain invert / invariance_sensitivity (200 epochs)"
echo "Started: $(date)"
echo "=========================================="
...
echo "=========================================="
echo "ALL DONE: invert / invariance_sensitivity"
echo "Finished: $(date)"
echo "=========================================="
